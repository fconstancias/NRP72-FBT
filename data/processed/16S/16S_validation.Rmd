...
```{r, include=FALSE}
# Alpha-diversity:
plot_alpha_div_NRP72 <- function(df, x = "Day_of_Treatment", y = "value",  point_size = 2.5, color = "Treatment", fill  = "Treatment", shape = "Antibiotic", alpha = "Antibiotic_mg.L", facet_formula = paste0("alphadiversiy ~  Model2 "), ylab = "16S alpha-diversity", xlab = "Days (Treatment)", measures = c("Observed"), path_group = "interaction(Model, Model2, Fermentation, Antibiotic_mg.L, Reactor_Treatment)"){
...
```{r, message= FALSE, warnings = FALSE, eval = TRUE, fig.width = 16}
alpha_df$data %>% 
