...
```{r}
"/Users/fconstan/Documents/GitHub/NRP72-FBT/data/processed/16S/ps_silva_dada2_human_chicken_all_fct_090922.RDSS" %>% 
  readRDS() -> ps
...
ps %>% 
  ...
  microViz::ps_mutate(Day_of_Treatment = as.double(Day_of_Treatment)) -> ps_all
...
```{r}
ps_all %>% 
  saveRDS("/Users/fconstan/Documents/GitHub/NRP72-FBT/data/processed/16S/ps_silva_dada2_human_chicken_all_fct_090922_up.RDS")
```
...
ps_all %>% 
  ...
  filter_taxa(function(x) sum(x > 0) > 0, TRUE) %>% 
    saveRDS("/Users/fconstan/Documents/GitHub/NRP72-FBT/data/processed/16S/ps_silva_dada2_human_chicken_all_fct_polyferms_090922_up.RDS")
```
